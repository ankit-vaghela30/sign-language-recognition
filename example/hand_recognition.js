...
// main
const delay = 20;
grabFrames('hand-gesture.mp4', delay, (frame) => {
  ...
  verticesWithValidAngle.forEach((v) => {
    ...
    resizedImg.drawEllipse(
      ...
      cv.imshow('Convex Hull', resizedImg);
    result.drawEllipse(
      new cv.RotatedRect(v.pt, new cv.Size(20, 20), 0),
      { color: red, thickness: 2 }
    );
